...
<a  href=""http://localhost:4200/reset?email={email}&code={emailToken}"" target=""_blank"" style=""padding: 10px 20px; background: #e7b630; border-radius: 3px; width: 50%; text-align: center; text-decoration: none;"">Redefinir senha</a>
</div>
</body>
</html>";
        }
